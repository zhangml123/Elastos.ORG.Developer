...
class MainController extends Controller {
    public function index(){
		if(isset($_SESSION ['ela']['role']) && $_SESSION ['ela']['role']!="" && isset($_SESSION ['ela']['userid']) && $_SESSION ['ela']['userid']!=""){
			...
			$html = "<div style='width:700px;height:197px;color:red;font-size:20px;font-weight:900;margin:0px auto;margin-top:150px;'><img src='https://".$_SERVER['HTTP_HOST']."/Public/financeadm/images/404.png' style='border:0px;margin:0px auto;'></div><div style='width:100%;height:50px;margin-top:60px;'><div style='width:400px;height:40px;margin:0px auto;'><a href='https://".$_SERVER['HTTP_HOST']."' style='border-radius:4px 4px;display:block;width:100px;height:40px;background-color:#226193;color:#fff;line-height:40px;text-align:center;float:left;margin-left:30px;text-decoration:none;'>返回首页</a><a href='https://".$_SERVER['HTTP_HOST']."/financeadm.php'  style='border-radius:4px 4px;float:left;margin-left:135px;display:block;width:100px;height:40px;background-color:#e5e5e5;color:#333;line-height:40px;text-align:center;cursor:pointer;text-decoration:none;'>重新登录</a></div></div>";
			$this->show($html);
		}
	}
