...
internationalWordsZH.loginemailtip='请输入有效的电子邮箱';
...
internationalWordsZH.forgetpwdtip ='请输入你之前注册的电子邮箱，我们将发送一个验证码到你的电子邮箱';
internationalWordsEN.forgetpwdtip='We hava send a code to your Email,please input an Email you hava registered';
internationalWordsZH.forgetpwdemail ='电子邮箱';
internationalWordsEN.forgetpwdemail='Email';
internationalWordsZH.forgetpwdemailtip ='请输入有效的电子邮箱';
internationalWordsEN.forgetpwdemailtip='Please input valid Email!';
...
internationalWordsEN.forgetpwdcode="Please input the code you have recieved,if you don't receive a code,click here to ";
...
internationalWordsEN.forgetpwdcodec="Code";
internationalWordsZH.forgetpwdcodetip ='请输入有效的验证码';
internationalWordsEN.forgetpwdcodetip="Please input valid Code";
//重置密码页面
...
internationalWordsEN.resetpwdtip="Password does not match,and not null!";
//注册页面
...
internationalWordsZH.profileeditfirstname='名';
internationalWordsEN.profileeditfirstname='First Name';
internationalWordsZH.profileeditlastname='姓';
...
internationalWordsEN.githubbinderror='The GitHub account is already bound. Please unbind it and bind it again.';
internationalWordsZH.bindsuc='解除绑定成功.';
internationalWordsEN.bindsuc='Unbinding Successful.';
internationalWordsZH.confirmunbind='确定要解除绑定？';
internationalWordsEN.confirmunbind='Are you sure you want to unbind?';
...
internationalWordsEN.wechatbindedtip='This Wechat account is already bound. Please unbind it first and then bind it.';
